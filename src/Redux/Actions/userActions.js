...
export const register = (name, email,adresseC, password,confirmPassword , pic) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `https://esprit-network.onrender.com/api/users/`,
...
export const registeralumni = (name, email, password,confirmPassword , pic) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `https://esprit-network.onrender.com/api/users/register-alumni`,
...
export const registerteacher = (name, email, password,confirmPassword , pic) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `https://esprit-network.onrender.com/api/users/register-teacher`,
      { name, email, password,confirmPassword , pic },
      config
    );
    dispatch({ type: USER_REGISTER_SUCCESS, payload: data });
...
export const registeresprit = (name, email, password,confirmPassword , pic) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `https://esprit-network.onrender.com/api/users/register-esprit`,
      { name, email, password,confirmPassword , pic },
      config
    );
    dispatch({ type: USER_REGISTER_SUCCESS, payload: data });
...
export const getUserDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`https://esprit-network.onrender.com/api/users/${id}`, config);
...
export const updateUserProfile = (user) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(`https://esprit-network.onrender.com/api/users/profile`, user, config);
